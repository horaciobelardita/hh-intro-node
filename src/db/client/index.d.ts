...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, ClientOptions = {}> = {
    meta: {
      modelProps: "user" | "student" | "instructor"
  ...
  interface StudentFieldRefs {
    ...
    readonly instructorId: FieldRef<"Student", 'String'>
  }
  ...
  export interface Prisma__InstructorClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    students<T extends Instructor$studentsArgs<ExtArgs> = {}>(args?: Subset<T, Instructor$studentsArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$StudentPayload<ExtArgs>, T, "findMany"> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  export type StudentWhereInput = {
    ...
    instructorId?: StringFilter<"Student"> | string
  ...
  export type StudentScalarWhereWithAggregatesInput = {
    ...
    instructorId?: StringWithAggregatesFilter<"Student"> | string
  }
  ...
  export type StudentUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    instructor?: InstructorUpdateOneRequiredWithoutStudentsNestedInput
  }
